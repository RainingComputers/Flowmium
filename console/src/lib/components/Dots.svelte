...
<div class="flex flex-col items-center justify-center h-screen w-full bg-base-0">
	<canvas bind:this={canvas} class="fixed h-screen w-screen opacity-25" />
	<slot />
</div>
